...
Replace the dummy item data displayed in the main area of the dashboard (right side), with actual data from the database. This includes both pinned and recent items. It should look the same as how it does now, but should be using Prisma and the Neon database instead of using data from`@src/lib/mock-data.ts.`
