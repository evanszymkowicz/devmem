...
- Pagination controls at bottom with page numbers and interactive prev/next links
- Disable (grey out) prev/next when not available
- use NULL if not an option (prev/next)
- Use constants: ITEMS_PER_PAGE = 21, COLLECTIONS_PER_PAGE = 21 (we probably do not have 21 items created)
